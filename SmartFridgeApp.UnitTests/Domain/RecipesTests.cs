...
namespace SmartFridgeApp.UnitTests.Domain
{
    ...
    public class RecipesTests
    {
        ...
        {
            Recipe recipe;
            List<RecipeFoodProduct> list = new List<RecipeFoodProduct>();
        ...
        public void CreateNewRecipeWithoutNameShouldThrowException()
        {
            ...
            list.Add(new RecipeFoodProduct());
        ...
        public void CreateNewRecipeWithNameAndProductsShouldBeFine()
        {
            Recipe recipe = null;
            List<RecipeFoodProduct> list = new List<RecipeFoodProduct>();
            RecipeFoodProduct rfp = new RecipeFoodProduct();
            rfp.FoodProductId = 1;
            rfp.RecipeId = 1;
            ...
            Assert.AreEqual(1, recipe.RecipeFoodProducts.Count);
        }
