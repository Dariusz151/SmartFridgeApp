...
namespace SmartFridgeApp.Migrations
{
    ...
    [Migration("20190924172031_identity5")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SmartFridgeApp.Identity.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("SmartFridgeApp.Identity.ApplicationUser")
                        .WithMany()
            ...
            modelBuilder.Entity("SmartFridgeApp.Identity.ApplicationUser", b =>
                {
                    b.HasOne("SmartFridgeApp.Domain.Models.UserGroup", "UserGroups")
                        .WithMany()
