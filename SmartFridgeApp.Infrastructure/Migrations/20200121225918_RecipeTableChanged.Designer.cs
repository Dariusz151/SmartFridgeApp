...
namespace SmartFridgeApp.Infrastructure.Migrations
{
    ...
    [Migration("20200121225918_RecipeTableChanged")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SmartFridgeApp.Domain.Shared.RecipeFoodProduct", b =>
                {
                    b.Property<int>("FoodProductId");
            ...
            modelBuilder.Entity("SmartFridgeApp.Domain.Shared.RecipeFoodProduct", b =>
                {
                    b.HasOne("SmartFridgeApp.Domain.Models.FoodProducts.FoodProduct", "FoodProduct")
                        .WithMany("RecipeFoodProducts")
                        .HasForeignKey("FoodProductId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("SmartFridgeApp.Domain.Models.Recipes.Recipe", "Recipe")
                        .WithMany("RecipeFoodProducts")
