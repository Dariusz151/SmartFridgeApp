...
{
    public class GetFoodProductsQueryHandler : IRequestHandler<GetFoodProductsQuery, List<FoodProduct>>
    {
        ...
        public async Task<List<FoodProduct>> Handle(GetFoodProductsQuery request, CancellationToken cancellationToken)
        {
